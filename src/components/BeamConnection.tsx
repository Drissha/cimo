...
export function DemoBeamsConnecting_Converge() {
      ...
      <div className="flex h-full w-full flex-col items-stretch justify-between gap-16">
        <div className="flex flex-row items-center justify-between">
          <BeamCircle ref={div1Ref}>
            <Logos.framerMotion className="size-8" />
          </BeamCircle>
          <BeamCircle ref={div5Ref}>
            <Logos.shadcn className="size-8 text-neutral-950" />
          </BeamCircle>
        </div>
        <div className="flex flex-row items-center justify-between">
          <BeamCircle ref={div2Ref}>
            <Logos.aceternity className="w-20 text-neutral-950" />
          </BeamCircle>
          <BeamCircle ref={div4Ref} className="size-16">
            <Logos.everUI className="size-10" />
          </BeamCircle>
          <BeamCircle ref={div6Ref}>
            <Logos.nextJs className="size-8" />
          </BeamCircle>
        </div>
        <div className="flex flex-row items-center justify-between">
          <BeamCircle ref={div3Ref}>
            <Logos.lucideReact className="size-8" />
          </BeamCircle>
          <BeamCircle ref={div7Ref}>
            <Logos.tailwind className="size-8" />
          </BeamCircle>
        </div>
      </div>
